const generateStreakGrid = (days = 35) =>
  Array.from({ length: days }, (_, index) => ({
    completed: index % 6 !== 0,
    today: index === days - 1,
    proteinPerfect: index % 4 === 0,
  }))

const baseAthleteTemplate = {
  profile: {
    name: 'Jordan Vega',
...
export const duplicateBaseAthlete = () => JSON.parse(JSON.stringify(baseAthleteTemplate))

export const createBaseAthlete = () => {
  const clone = duplicateBaseAthlete()
  clone.streak.grid = generateStreakGrid(clone.streak.grid.length || 35)
  return clone
}

export { generateStreakGrid }
